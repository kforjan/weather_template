...
class _$WeatherResponseImpl implements _WeatherResponse {
  ...
  @override
  String toString() {
    return 'WeatherResponse(temperature: $temperature, humidity: $humidity, cityName: $cityName, weatherType: $weatherType)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, temperature, humidity, cityName, weatherType);
...
abstract class _WeatherResponse implements WeatherResponse {
  const factory _WeatherResponse(
      ...
      required final WeatherType weatherType}) = _$WeatherResponseImpl;
